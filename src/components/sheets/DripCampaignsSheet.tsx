...
import { arrowDownBorderIcon, arrowUpIcon, smsIcon, tickShadowIcon, timelineIcon } from "../../utils/assets";
...
const DripCampaignsSheet = () => {
    ...
    return (
        <MainWrapperWhite>
            ...
            <TopWrapper >
                <ImageView height={30} width={30} source={timelineIcon} />
                <TextView marginTop={10} fontSize={18}>Drip Campaigns</TextView>
            </TopWrapper>
...
export default withTheme(DripCampaignsSheet)
