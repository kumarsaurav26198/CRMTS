...
import { arrowDownBorderIcon, arrowUpIcon, dropdownIcon, emailOpenIcon, tickShadowIcon } from "../../utils/assets";
...
const EmailTemplatesSheet = () => {
    ...
    return (
        <MainWrapperWhite>
            ...
            <TopWrapper >
                <ImageView height={30} width={30} source={emailOpenIcon} />
                <TextView marginTop={10} fontSize={18}>Email Templates</TextView>
            </TopWrapper>
...
export default withTheme(EmailTemplatesSheet)
